...
void testPlaneAd()
{
    ...
    std::cout << "总点数:" << Pnumber << ","
              << "已知点数" << knPnumber << ","
              << "方向组总数" << Lnumber << ","
              << "方向值总数" << Nnumber << ","
              << "边长观测值总数" << Snumber << ","
              << "方位角总数" << Tnumber;
    std::cout << "方向值中误差" << ma << "方位角中误差" << ms1 << "边长固定误差" << ms2 << "比例误差" << mt;
    for (int i = 0; i < Pnumber * 2; i++) {
        std::cout << "XY\t " << i << "\t" << XY[i] << std::endl;
    }
    for (int i = 0; i < Pnumber; i++) {
        std::cout << "pname\t" << pname[i] << std::endl;
    }
    for (int i = 0; i < Lnumber + 1; i++) {
        std::cout << "dir0\t" << dir0[i] << std::endl;
    }
    for (int i = 0; i < Lnumber; i++) {
        std::cout << "dir1\t" << dir1[i] << "\t点名\t" << pname[dir1[i]] << std::endl;
    }
    for (int i = 0; i < Nnumber; i++) {
        std::cout << "dir2\t " << dir2[i] << "\t点名\t" << pname[dir2[i]] << std::endl;
    }
    std::cout << "           " << std::endl;
    for (int i = 0; i < Nnumber; i++) {
    ...
    for (int i = 0; i < Snumber; i++) {
        std::cout << "Sdir1\t " << i << "\t" << S_dir1[i] << std::endl;
    }
    std::cout << "           " << std::endl;
    for (int i = 0; i < Snumber; i++) {
        std::cout << "Sdir2\t " << i << "\t" << S_dir2[i] << std::endl;
    }
    std::cout << "           " << std::endl;
    for (int i = 0; i < Snumber; i++) {
        std::cout << "S_L\t " << i << "\t" << S_L[i] << std::endl;
    }
    std::cout << "           " << std::endl;
    for (int i = 0; i < Tnumber; i++) {
        std::cout << "Tdir1\t " << i << "\t" << T_dir1[i] << std::endl;
    }
    std::cout << "           " << std::endl;
    for (int i = 0; i < Tnumber; i++) {
        std::cout << "Tdir2\t " << i << "\t" << T_dir2[i] << std::endl;
    }
    std::cout << "           " << std::endl;
    for (int i = 0; i < Tnumber; i++) {
        std::cout << "T_L\t " << i << "\t" << T_L[i] << std::endl;
    }
    std::cout << "           " << std::endl;
